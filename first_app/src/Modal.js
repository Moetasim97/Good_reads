            ...
            <div className="modal_background">
                ...
                <div className="container"> 
                    <div className="row pt-3">
                        ...
                        this.state.minified_data.map((book)=><Books state={book} all_shelves={this.props.shelves} appending_books={this.props.add_to_shelves} book_querying={this.props.book_querying} empty_book={this.props.single_book} filtered={this.props.filtering}/>):
